...
const BACKEND_NAME: &str = "agy-fleet-mcp-backend.exe";
const BACKEND_PORT: u16 = 10825;
const BACKEND_TAG: &str = "agy-fleet-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "AGY_FLEET_MCP_PORT";
const ENV_HOST: &str = "AGY_FLEET_MCP_HOST";
const ENV_TAURI: &str = "AGY_FLEET_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 10825",
    ...
    Ok(format!("Backend starting on port 10825"))
}
